...
|---|---|---|---|
| `region` | string | `EU` | Primary region (`POST /v1/invites .region`). Supported: `EU`, `NA` (North America). |
| `failoverRegions` | []string | — | Extra regions whose edges agents also dial (`EU`, `NA`). |
